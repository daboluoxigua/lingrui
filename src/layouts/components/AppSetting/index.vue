  ...
  <div>
    <el-drawer v-model="isShow" title="应用配置" direction="rtl" :size="360">
      ...
      <div class="color-scheme">
        <div
          class="switch"
          :class="settingsStore.settings.app.colorScheme"
      ...
      <div v-if="settingsStore.mode === 'pc'" class="menu-mode">
        ...
        <el-tooltip content="顶部模式（不含侧边导航）" placement="top" :show-after="500">
          <div
            class="mode mode-only-head"
            :class="{ active: settingsStore.settings.menu.menuMode === 'onlyHead' }"
            @click="settingsStore.settings.menu.menuMode = 'onlyHead'"
          >
            <div class="mode-container" />
            <el-icon>
              <svg-icon name="ep:check" />
