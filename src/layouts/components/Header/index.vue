  ...
  <transition name="header">
    <header
      v-if="
        ...
        (settingsStore.settings.menu.menuMode === 'head' || settingsStore.settings.menu.menuMode === 'onlyHead')
      "
    >
      <div class="header-container">
        <div class="main">
          <div class="logMenu">
            <div class="globalmMenu" :class="{ active: active }" @click="globalmMenuShow">
...
header {
  ...
  border-bottom: 1px solid var(--g-header-border-color);
...
.globalmMenu {
  background-color: var(--g-globalm-menu);
  width: var(--g-header-height);
  height: var(--g-header-height);
  display: flex;
  justify-content: center;
  align-items: center;
