...
<template>
  <div class="layout">
    <div id="app-main">
      ...
      <div class="wrapper">
        <div
          v-if="settingsStore.settings.menu.menuMode !== 'onlyHead'"
        ...
        <div class="main-container" :style="{ 'padding-bottom': $route.meta.paddingBottom } as any">
          <Topbar v-if="settingsStore.settings.breadcrumb.enable" />
          <div class="main">
      ...
      <el-backtop :right="20" :bottom="40" title="回到顶部" />
    </div>
    <Search />
    <HotkeysIntro />
